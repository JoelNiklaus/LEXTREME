...
def main():
    ...
    if training_args.do_train:
        train_dataset = load_dataset("greek_legal_code","chapter",split='train', cache_dir=model_args.cache_dir)
        

    if training_args.do_eval:
        eval_dataset = load_dataset("greek_legal_code","chapter",split='validation', cache_dir=model_args.cache_dir)

    if training_args.do_predict:
        predict_dataset = load_dataset("greek_legal_code","chapter",split='test', cache_dir=model_args.cache_dir)
    ...
    config = AutoConfig.from_pretrained(
        ...
        finetuning_task=data_args.language+"_greek_legal_code_chapter_level",
