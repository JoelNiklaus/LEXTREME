...
class DataTrainingArguments:
    ...
    finetuning_task:Optional[str] = field(
        default='online_terms_of_service_unfairness_levels',
        metadata={
...
def main():
    ...
    if training_args.do_predict:
        ...
        make_predictions_multi_class(trainer=trainer,data_args=data_args,predict_dataset=predict_dataset,id2label=id2label,training_args=training_args,list_of_languages=langs)
