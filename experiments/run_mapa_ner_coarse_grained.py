...
def main():
    ...
    def add_label_tags(examples):
        ...
        examples["ner_tags"] = [[label2id[l] for l in label] for label in examples["coarse_grained"]]

        del examples["coarse_grained"]
    ...
    config = AutoConfig.from_pretrained(
        ...
        finetuning_task=data_args.language+"_mapa_ner_coarse_grained",
