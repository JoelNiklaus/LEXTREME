...
for row in missing_runs.to_dict(orient="records"):
    ...
    command = 'python main.py -gn 0 -gm 80 -los ' + seeds + ' --lower_case true -bz 4 -as 2 -mfbm micro-f1 -nte 20 -lr 3e-5 -esp 3 -ld paper_results ' + '-t ' + ft + ' -lmt ' + name_or_path + ' -rev ' + revision
    os.system(command)
