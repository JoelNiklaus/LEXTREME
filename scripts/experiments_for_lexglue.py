...
for row in models.to_dict(orient="records"):
    ...
    for ft in tasks:
        command = 'python main.py -gn 0 -gm 80 -los 1,2,3,4,5 --lower_case true -bz 8 -mfbm micro-f1 -nte 20 -lr 3e-5 -esp 3 -ld paper_results ' + '-t '+ft +' -lmt '+ name_or_path +' -rev '+revision
        os.system(command)
