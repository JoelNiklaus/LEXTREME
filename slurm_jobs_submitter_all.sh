...
dataset_names=(
    ...
    "swiss_law_area_prediction_criminal_considerations"
    "swiss_law_area_prediction_criminal_facts"
    "swiss_law_area_prediction_civil_considerations"
    "swiss_law_area_prediction_civil_facts"
    "swiss_law_area_prediction_public_considerations"
    "swiss_law_area_prediction_public_facts"
